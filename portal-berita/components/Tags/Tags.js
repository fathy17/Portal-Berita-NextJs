                            ...
                            <Fragment key={data.id}>
                                <Grid item xs={12} sm={12} md={5} lg={5} xl={5} className="gMobile">
                                    <Link href={`/berita/${data.slug}`}>
                                        <Box className="boxMobile" style={{cursor: 'pointer', backgroundColor: 'grey', height: '145px', width: '100%', borderRadius: '6px' }}>
                                ...
                                <Grid item xs={12} sm={12} md={7} lg={7} xl={7}>
                                    <Link href={`/berita/${data.slug}`}>
                                        <h2 style={{ cursor: 'pointer', marginTop: '10px', marginBottom: '10px', fontWeight: '600', fontSize: '18px', fontStyle: 'normal', color: '#293462' }}>{data.title.rendered}</h2>
                                    </Link>
